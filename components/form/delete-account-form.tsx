  ...
  return (
    <form
      action={async (data: FormData) =>
        ...
        deleteAccount(data, id, "delete")
          .then(async (res: User | Error) => {
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 sm:p-10">
        <h2 className="font-cal text-xl dark:text-white">Delete Account</h2>
        <p className="text-sm text-stone-500 dark:text-stone-400">
          If you delete your account, you will not be able to recover it. Type
          in the email associated with your account <b>{email}</b> to confirm.
        </p>
